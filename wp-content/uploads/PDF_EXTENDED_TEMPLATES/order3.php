...
<style type="text/css"> 
body{
background:url("http://lingerieshow.cf/wp-content/uploads/PDF_EXTENDED_TEMPLATES/electronic_ticket/order.jpg") no-repeat;
...
<style type="text/css">
body{
background:url("http://lingerie-show-forum.ru/wp-content/uploads/PDF_EXTENDED_TEMPLATES/electronic_ticket/{Hidden Field:21}") no-repeat;
}	
</style>			
