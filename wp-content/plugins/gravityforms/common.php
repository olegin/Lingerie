...
<IfModule mod_php5.c>
  php_flag engine off
	...
	public static function get_submitted_fields( $form, $lead, $display_empty = false, $use_text = false, $format = 'html', $use_admin_label = false, $merge_tag = '', $options = '' ) {
		...
		$field_data = '';
		if ( $format == 'html' ) {
			$field_data = 'Большое спасибо за регистрацию на Международную выставку нижнего белья, домашней одежды, купальников и чулочно-носочной продукции Lingerie Show-Forum, которая состоится в феврале 2016 года (чуть позже будут уточнены даты).
<p>
Не забудьте, пожалуйста, взять с собой распечатанный билет для получения бейджа посетителя на выставке.
<p>
...
Татьяна Львова
<p>
Директор Lingerie Show-Forum
<br>Россия,119034, г.Москва, 1-ый Зачатьевский переулок, д.4
<br>м. +7 (985) 922-86-54
<br>р.  +7 (495) 695-22-28
<br>e-mail: Lsf@info-space.ru
<br>web: <a href="http://www.Lingerie-Show-Forum.ru">www.Lingerie-Show-Forum.ru</a>
<br>web: <a href="http://www.info-space.ru">www.info-space.ru</a> (сайт площадки)';
		}
