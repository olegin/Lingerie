...
<head>	
	...
	<?php 
		 ...
		 */
	?>
    <title>Lingerie Show-Forum</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<style type="text/css"> 
body{
background:url("http://lingerie-show-forum.ru/wp-content/uploads/PDF_EXTENDED_TEMPLATES/electronic_ticket/electronic_ticket-february.png") no-repeat;
